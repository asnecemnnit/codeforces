...
void solve()
{
	...
	if((s.substr(0,1)=="2" and s.substr(n-3,3) == "020")
		or (s.substr(0,2)=="20" and s.substr(n-2,2) == "20")
		or (s.substr(0,3)=="202" and s.substr(n-1,1) == "0")
		or (s.substr(0,2)=="20" and s.substr(n-2,2) == "20")
		or (s.substr(0,4)=="2020")
		or (s.substr(n-4,4)=="2020"))
	{
		cout<<"YES"<<endl;
		return;
	}
