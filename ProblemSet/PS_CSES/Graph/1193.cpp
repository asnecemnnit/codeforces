...
// void dfs(int prev_x, int prev_y, int x, int y, string s, int cnt) {
// 	// cout << x << " " << y << " " << s << endl;
// 	if (cnt > dp[x][y])
// 		return;
...
// 	REP(i, 4) {
// 		int nbx = x + nb[i][0], nby = y + nb[i][1];

// 		if (nbx == -1 or nby == -1 or nbx == n or nby == m) {
// 			continue;
// 		}

// 		if (!(prev_x == nbx and prev_y == nby)) {
// 			if (lab[nbx][nby] == 'B') {
// 				dfs(x, y, nbx, nby, s + dir[i], cnt + 1);
// 				break;
// 			}
// 			if (lab[nbx][nby] == '.') {
// 				dfs(x, y, nbx, nby, s + dir[i], cnt + 1);
...
// inline pair<int, int> prev(char dir) {
// 	if (dir == 'L') {
