...
void solve()
{
	...
	for (int i = 63; i >= 0; i--) {
		// cout << u << " " << v << "\n";
		int vset = (v >> (uint64)i) & (uint64)1, uset = (u >> (uint64)i) & (uint64)1;
		dbg4(i, vset, uset, carry);
		if ((((v >> (uint64)i) & (uint64)1) == (uint64)1) and (((u >> (uint64)i) & (uint64)1)  == (uint64)0)) {
			if (!carry) {
				a += (uint64)0 << (uint64)i;
				b += (uint64)0 << (uint64)i;
				carry = 1;
		...
		else if ((((v >> (uint64)i) & (uint64)1)  == (uint64)0) and (((u >> (uint64)i) & (uint64)1) == (uint64)1)) {
			a += (uint64)1 << (uint64)i;
			b += (uint64)0 << (uint64)i;
			carry = 1;

		}
		else if ((((v >> (uint64)i) & (uint64)1)  == (uint64)1) and (((u >> (uint64)i) & (uint64)1) == (uint64)1)) {
