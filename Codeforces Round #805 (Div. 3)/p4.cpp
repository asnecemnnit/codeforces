...
bool compId(pair<char, int> a, pair<char, int> b) {
...
void solve()
{
	...
	s.erase( s.begin(), s.size() > removeFirstElements ?  s.begin() + removeFirstElements : s.end() );

	sort(s.begin(), s.end(), compId);
